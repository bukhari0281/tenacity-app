      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-16 md:py-20">
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-[280px]">
              Jasa pengerjaan tugas kuliah terpercaya sejak 2019. Membantu ratusan mahasiswa
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm">© 2024 Tenacity. All rights reserved.</p>
            <p className="text-gray-500 text-sm">Made with ❤️ for Indonesian Students</p>
          </div>
        </motion.div>
      </div>
