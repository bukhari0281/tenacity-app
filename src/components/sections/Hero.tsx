...
export default function Hero() {
  const trustIndicators = ["Garansi Revisi", "24/7 Support", "Harga Terjangkau"];

  return (
    <section id="home" className="min-h-screen relative overflow-hidden pt-20 md:pt-0">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center py-12">
            ...
            >
              ...
              >
                ...
                Menumpuk? <span className="gradient-text">Serahkan Pada Ahlinya!</span>{" "}
              ...
              >
                Jasa pengerjaan tugas kuliah dengan kualitas terjamin, tepat waktu, dan 100%
                confidential. Jalani hidupmu biar tugas urusanku.
              </motion.p>
              ...
              <div className="relative">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-sm text-gray-800">Tugas Selesai!</p>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-sm text-gray-800">Rating 5.0</p>
