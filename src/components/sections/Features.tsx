            ...
            >
              ...
              >
                <div className="relative w-full max-w-md mx-auto lg:max-w-none">
                  <div className="aspect-square rounded-3xl overflow-hidden bg-gradient-to-br from-[#A8D5E2]/10 to-[#5BA8C4]/10 border border-slate-100 shadow-xl flex items-center justify-center group/img relative">
                    <Image
                      src={feature.image}
                      alt={feature.title}
                      width={500}
